...
corpus = open("/Users/tessacharlesworth/Desktop/Embeddings/Child_TV/nick_corpus.txt", 'w+')
website = requests.get("http://transcripts.wikia.com/wiki/Category:Nickelodeon")
