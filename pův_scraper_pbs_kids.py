...
corpus = open("/Users/tessacharlesworth/Desktop/Embeddings/Child_TV/pbs_kids_corpus.txt", 'w+')
website = requests.get("http://transcripts.wikia.com/wiki/Category:PBS_Kids")
